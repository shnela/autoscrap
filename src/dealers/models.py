...
AutoscoutUrls = namedtuple("AutoscoutUrls", "dealers_list_url dealer_url_template")
AUTOSCOUT_URLS = {
    ITALY_CODE: AutoscoutUrls(
        "https://concessionari.autoscout24.it/DealersSearch/Find", "https://www.autoscout24.it/concessionari/{}/veicoli"
    ),
    FRANCE_CODE: AutoscoutUrls(
        "https://garages.autoscout24.fr/DealersSearch/Find", "https://www.autoscout24.fr/garages/{}/vehicules"
    ),
    GERMANY_CODE: AutoscoutUrls(
        "https://haendler.autoscout24.de/DealersSearch/Find", "https://www.autoscout24.de/haendler/{}/fahrzeuge"
    ),
}
